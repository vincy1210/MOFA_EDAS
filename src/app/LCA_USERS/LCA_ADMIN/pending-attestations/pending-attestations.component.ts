...
@Component({
  selector: 'app-pending-attestations',
  templateUrl: './pending-attestations.component.html',
  styleUrls: ['./pending-attestations.component.css'],
  providers: [MessageService, ConfirmationService],
})
export class PendingAttestationsComponent
  extends LayoutModel
  implements OnInit
{
  ...
  getLcaDetailList(data: any) {
    ...
    const getLists = this.consts.getPendingReqforlcauser;
    this.loading = true;
