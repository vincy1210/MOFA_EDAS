...
@Component({
  selector: 'app-lca-in-hold',
  templateUrl: './lca-in-hold.component.html',
  styleUrls: ['./lca-in-hold.component.css']
})
export class LcaInHoldComponent implements OnInit {
...
this.common.showLoading();
    ...
    this.api.post(this.consts.getInRiskReqforlcauser,data).subscribe({next:(success:any)=>{
